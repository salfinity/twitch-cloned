  ...
  return (
    <div id='live' className='p-2 md:p-8'>
      <h2 className='text-xl font-bold px-2'>
        <span className='text-purple-600'>Live Channels</span> we think you&apos;ll
        like
      </h2>
      {/* Container */}
      <div className='grid sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4 3xl:grid-cols-5 gap-4 py-2'>
        <LiveChannelItem
          img={Live1}
          profile_img='https://static-cdn.jtvnw.net/jtv_user_pictures/2f73ee00-5d2d-499d-9a85-58f1369831ec-profile_image-50x50.png'
        ...
        <LiveChannelItem
          img={Live2}
          profile_img='https://static-cdn.jtvnw.net/jtv_user_pictures/aee9bad3-cac4-459a-8854-8584bc30d6d9-profile_image-50x50.png'
        ...
        <LiveChannelItem
          img={Live3}
          profile_img='https://static-cdn.jtvnw.net/jtv_user_pictures/6231a3d5-76eb-40a8-977a-022251cfd6e7-profile_image-50x50.png'
        ...
        <LiveChannelItem 
          img={Live7}
          profile_img='https://static-cdn.jtvnw.net/jtv_user_pictures/20876f05-472f-46b8-bff0-bc77fc4c2bc8-profile_image-50x50.png'
          title='i have found YOU!!!'
          user='coletteleclair'
          game='Just Chatting'
        />
        <LiveChannelItem
